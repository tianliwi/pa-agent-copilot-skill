...
_O_SERIES_RE = _re.compile(r"^o\d", _re.IGNORECASE)


def _model_is_o_series(model: str) -> bool:
    """OpenAI o-series models (o1, o3, o4-mini, …) require max_completion_tokens."""
    return bool(_O_SERIES_RE.match((model or "").strip()))
...
# OpenAI o-series (o1, o3, o4-mini, …): max 100_000 completion tokens.
_O_SERIES_MAX_OUTPUT_TOKENS = 100_000
...
def _provider_max_output_tokens(settings: AIProviderSettings) -> int:
    ...
    if _model_is_o_series(settings.model):
        return _O_SERIES_MAX_OUTPUT_TOKENS
...
class DeepSeekClient:
    ...
    def chat(
        ...
        *,
        ...
        if _model_is_o_series(self._settings.model):
    ...
    def stream_chat(
        ...
        *,
        ...
        try:
            ...
            # o-series models require max_completion_tokens instead of max_tokens
            if _model_is_o_series(self._settings.model):
                stream_kwargs["max_completion_tokens"] = _max_tokens
            else:
